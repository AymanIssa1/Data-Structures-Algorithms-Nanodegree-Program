...
def dijkstra(graph, source):
    ...
    while unvisited:
        ...
        print("Node: " + str(min_node) + ", current_distance:" + str(current_distance))
        ...
        for neighbour in graph.neighbours[min_node]:
            print("for " + str(neighbour) + " in " + str(graph.neighbours[min_node]))
            if neighbour in unvisited:
                print("neighbour in unvisited: " + str(neighbour) + ", unvisited: " + str(unvisited))
                distance = current_distance + graph.distances[(min_node, neighbour)]
                print("distance: " + str(distance) + " = " + str(current_distance) + " + " + str(graph.distances[(min_node, neighbour)]))

                # 3. If the calculated distance of the unvisited neighbour
